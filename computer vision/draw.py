...
cv2.circle(img, (400, 300), 100, (255,0,0), -1)#line,rectangle,circle function have 6 parameters : image,start point,end point,(for circle center coordinates and radius),colour,thickness,linetype
